...
class Contactform24Helper
{
	...
	*/
	...
	static function setDocument( $title = '', $basepath, $metadesc = '', $metakey = '' )
	{
		...
		$doc->addScript( $basepath . '/components/com_contactform24/assets/scripts/contactform24.js' );
		$doc->addStyleSheet( $basepath . '/components/com_contactform24/assets/styles/contactform24.css' );
